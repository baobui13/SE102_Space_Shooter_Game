...
constexpr int EXPLOSION_START_X = 80;
constexpr int EXPLOSION_START_Y = 0;
...
ExplodingBullet::ExplodingBullet(Graphics& gfx,
    ...
    , m_dirX(0.0f)
    , m_dirY(-1.0f) {
    m_anim.Initialize(AssetManager::GetInstance().GetTexture(gfx, L"Assets/ExplodingBullet_1.png"));
    m_anim.AddClip("Bullet",
                   BULLET_FRAME_X,
                   BULLET_FRAME_Y,
                   BULLET_FRAME_W,
                   BULLET_FRAME_H,
